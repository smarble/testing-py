...
def is_mel(name, email):
    ...
    False
    >>> is_mel('Mel Melitpolski', 'mel@tool.com')
    True
    >>> is_mel("Melodius Melitposli", "mel@ubermelon.com")
    True
    """
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'drink'}, {'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'drink'}])
    ('dessert', 'appetizer')
    >>> most_and_least_common_type([{'type': 'dessert'}])
    ('dessert', 'dessert')
    >>> most_and_least_common_type([{'type': 'drink'}, {'type': 'drink'}, {'type': 'dessert'}, {'type': 'appetizer'}])
    ('drink', 'dessert')
